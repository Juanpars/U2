...
Interfaz minimalista en modo oscuro. Cada acción del CRUD tiene un color fijo
para que el estado de la interfaz se lea de un vistazo, sin depender de texto:
